...
def identify():    #скрипт писал не сам, спиздил у Root@Blackploit и Zion3R, сайт -> www.Blackploit.com
    #оригинал: https://github.com/blackploit/hash-identifier/blob/master/hash-id.py
    version = 1.2
